-- Youth Groups Schema Fix Script
-- This script fixes all database schema inconsistencies and creates missing tables
-- Run this script to resolve all critical database issues
