-- Quiz Questions Seeding Script (FIXED VERSION)
-- This script populates the quiz_questions table with comprehensive questions for all categories
-- Uses correct column name: correct_answer (snake_case)
...
CREATE TABLE IF NOT EXISTS quiz_questions (
    ...
    correct_answer INTEGER NOT NULL,  -- FIXED: using snake_case
