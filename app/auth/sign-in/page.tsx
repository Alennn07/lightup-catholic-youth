      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-500/20 to-purple-500/20 backdrop-blur-sm border border-pink-500/30 rounded-full px-4 py-2">
            ...
            <span className="text-pink-300 text-sm font-medium">Welcome back</span>
          </div>
        </div>
        ...
        <Card className="backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl">
          <Tabs defaultValue="email" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 bg-white/10">
              <TabsTrigger value="email" className="data-[state=active]:bg-pink-500/20 data-[state=active]:text-white">
                Email
              </TabsTrigger>
              <TabsTrigger value="group" className="data-[state=active]:bg-pink-500/20 data-[state=active]:text-white">
                Group Login
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="email">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-white/70">Welcome back! Continue your faith journey.</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSignIn} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <Link href="/auth/forgot-password" className="text-xs text-pink-400 hover:text-pink-300">
                        Forgot password?
                      </Link>
                    </div>
                    <div className="relative">
              ...
              <CardFooter className="flex justify-center">
                <p className="text-sm text-white/70">
                  ...
                  <Link href="/auth/sign-up" className="text-pink-400 hover:text-pink-300 font-medium">
                    Sign up
                  </Link>
                </p>
              </CardFooter>
            ...
            <TabsContent value="group">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-white">Group Login</CardTitle>
                <CardDescription className="text-white/70">
                  Sign in to manage your youth group and calendar.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="group-id" className="text-white/90">
                      Group ID
                    </Label>
                    <Input
                      id="group-id"
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <Label htmlFor="group-password" className="text-white/90">
                        Password
                      </Label>
                      <Link href="/auth/forgot-password" className="text-xs text-pink-400 hover:text-pink-300">
                        Forgot password?
              ...
              <CardFooter className="flex justify-center">
                <p className="text-sm text-white/70">
                  Need to register your group?{" "}
                  <Link href="/auth/group-registration" className="text-pink-400 hover:text-pink-300 font-medium">
                    Register here
                  </Link>
                </p>
              </CardFooter>
